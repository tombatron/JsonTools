...
public class JsonSamples {
    ...
    public static final String KNOWN_GOOD_SMALL_OBJECT_SAMPLE = "{\n" +
    ...
    public static final String KNOWN_GOOD_SMALL_OBJECT_SAMPLE_2 = "{\n" +
            "    \"glossary\": {\n" +
    ...
    public static final String KNOWN_GOOD_SMALL_OBJECT_SAMPLE_3 = "{\"menu\": {\n" +
            "  \"id\": \"file\",\n" +
            "  \"value\": \"File\",\n" +
            "  \"popup\": {\n" +
            "    \"menuitem\": [\n" +
    ...
    public static final String KNOWN_GOOD_LARGE_OBJECT_SAMPLE = "{\"web-app\": {\n" +
            "  \"servlet\": [   \n" +
            "    {\n" +
    ...
    public static final String KNOWN_GOOD_LARGE_ARRAY_SAMPLE = "[\n" +
            "  {\n" +
    ...
    public static final String KNOWN_GOOD_SMALL_NESTED_ARRAY_SAMPLE = "{\"menu\": {\n" +
            "    \"header\": \"SVG Viewer\",\n" +
            "    \"items\": [\n" +
            "        {\"id\": \"Open\"},\n" +
    ...
    public static final String KNOWN_GOOD_SMALL_NESTED_OBJECT_SAMPLE = "{\"widget\": {\n" +
            "    \"debug\": \"on\",\n" +
            "    \"window\": {\n" +
    ...
    public static final String KNOWN_BAD_LARGE_OBJECT_SAMPLE = "{\"web-app\": {\n" +
            "  \"servlet\": [   \n" +
            "    {\n" +
            "      \"servlet-name\": \"cofaxCDS\",\n" +
            "      \"servlet-class\": \"org.cofax.cds.CDSServlet\",\n" +
    ...
    public static final String KNOWN_BAD_LARGE_ARRAY_SAMPLE = "[\n" +
            "  {\n" +
            "    \"_id\": \"54bee3bd7c3040bb22bb4261\",\n" +
            "    \"index\": 0,\n" +
            "    \"guid\": \"b64e47d0-0dea-4493-90e6-ae7bd702bd09\",\n" +
