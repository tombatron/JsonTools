...
public class IsTests {
    ...
    public void testCase1IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_SMALL_OBJECT_SAMPLE));
    }

    @Test
    public void testCase2IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_STRING_ARRAY));
    }

    @Test
    public void testCase3IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_ARRAY_OF_ARRAYS));
    }

    @Test
    public void testCase4IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_SMALL_OBJECT_SAMPLE_2));
    }

    @Test
    public void testCase5IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_SMALL_OBJECT_SAMPLE_3));
    }

    @Test
    public void testCase6IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_SMALL_NESTED_OBJECT_SAMPLE));
    }

    @Test
    public void testCase7IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_LARGE_OBJECT_SAMPLE));
    }

    @Test
    public void testCase8IsValid() {
        assertTrue(Is.json(JsonSamples.KNOWN_GOOD_SMALL_NESTED_ARRAY_SAMPLE));
    }
